...
const NFTUserItem = ({ image, id }) => {
  return (
    <li
      key={id}
      className="bg-[#FFECA7] shadow-lg border-2 border-[#e0b77a] rounded-xl flex flex-col gap-1 p-2"
    >
      <div className="flex justify-center items-center w-36 h-24 sm:w-56 sm:h-44 bg-[#FFF4CE] rounded-t-xl">
        {image ? image : <img src={tag} alt="tag" className="w-24 md:w-44" />}
      </div>
